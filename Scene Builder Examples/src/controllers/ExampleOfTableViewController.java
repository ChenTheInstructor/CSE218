...
public class ExampleOfTableViewController implements Initializable {
	...
	private ObservableList<Person> observableList = getPeople();
	...
	public void changeScreenButtonPushed(ActionEvent event) throws IOException {
		Parent tableViewParent = FXMLLoader.load(getClass().getResource("/views/FXMLDocument.fxml"));
	...
	/**
	 * When this method is called, it will pass the selected Person object to the
	 * detailed view
	 */
	public void changeSceneToDetailedPersonView(ActionEvent event) throws IOException {
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(getClass().getResource("/views/PersonView.fxml"));
...
//		people.add(newPerson);
	...
	public ObservableList<Person> getPeople() {
		...
		people.add(new Person("Frank", "Sinatra", LocalDate.of(1915, Month.DECEMBER, 12),
				new Image("/images/FrankSinatra.jpg")));
